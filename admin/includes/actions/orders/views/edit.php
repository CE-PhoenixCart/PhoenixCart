      ...
      <div class="tab-pane fade" id="section_status_history_content" role="tabpanel">
        <?= new Form('status', $Admin->link('orders.php')->retain_query_except()->set_parameter('action', 'update_order')) ?>
          ...
          <div class="form-group row align-items-center" id="zNotifyComments">
            ...
            <div class="col-sm-9 pl-5 custom-control custom-switch">
              <?= (new Tickable('notify_comments', ['value' => 'on', 'class' => 'custom-control-input', 'id' => 'oNotifyComments'], 'checkbox'))->tick() ?>
          ...
          <p><?= new Button(IMAGE_SAVE, 'fas fa-save', 'btn-success btn-block btn-lg') ?></p>
