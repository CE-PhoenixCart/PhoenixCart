...
*/
  ...
  class cm_cs_thank_you extends abstract_executable_module {
    ...
    public function execute() {
      $content_width = MODULE_CONTENT_CHECKOUT_SUCCESS_THANK_YOU_CONTENT_WIDTH;
    ...
    protected function get_parameters() {
      return [
        'MODULE_CONTENT_CHECKOUT_SUCCESS_THANK_YOU_STATUS' => [
          'title' => 'Enable Thank You Module',
          'value' => 'True',
          'desc' => 'Should the thank you block be shown on the checkout success page?',
