...
?>
    ...
    <a class="mt-2 btn btn-danger" role="button" href="<?= $GLOBALS['Linker']->build('logoff.php') ?>"><?= MODULE_CONTENT_FOOTER_ACCOUNT_BOX_LOGOFF ?></a>
    
<?php
    } else {
?>
    <a class="mt-2 btn btn-success" role="button" href="<?= $GLOBALS['Linker']->build('login.php') ?>"><?= MODULE_CONTENT_FOOTER_ACCOUNT_BOX_LOGIN ?></a>
