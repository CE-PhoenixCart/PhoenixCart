...
*/
  ...
  $log_query = $GLOBALS['db']->query($log_query_raw);
?>
...
?>
    ...
    <tr>
      ...
      <td class="pp-table-action text-right"><?= $OSCOM_PayPal->drawButton($OSCOM_PayPal->getDef('button_view'), $GLOBALS['Admin']->link('paypal.php', ['action' => 'log', 'page' => $_GET['page'], 'lID' => $log['id'], 'subaction' => 'view']), 'info') ?></td>
    </tr>
