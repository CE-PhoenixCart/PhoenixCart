...
*/
  ...
  $contents[] = ['text' => TEXT_INFO_CLASS_TITLE . '<br>' . new Select('tax_class_id', Tax::fetch_classes())];
  $contents[] = ['text' => TEXT_INFO_ZONE_NAME . '<br>' . new Select('tax_zone_id', geo_zone::fetch_options())];
