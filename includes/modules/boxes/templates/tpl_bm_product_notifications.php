<div class="card mb-2 bm-product-notifications">
  ...
  <div class="list-group list-group-flush">
    <?= $notification_exists
      ? '<a class="list-group-item list-group-item-action" href="' . $GLOBALS['Linker']->build()->retain_query_except()->set_parameter('action', 'notify_remove') . '" rel="nofollow"><i class="fas fa-times"></i> ' . sprintf(MODULE_BOXES_PRODUCT_NOTIFICATIONS_BOX_NOTIFY_REMOVE, Product::fetch_name($_GET['products_id'])) .'</a>'
