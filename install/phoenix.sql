...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Store Name', 'STORE_NAME', 'Phoenix', 'The name of my store', '1', '1', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Last Update Check Time', 'LAST_UPDATE_CHECK_TIME', '', 'Last time a check for new versions of Phoenix was run', '6', '0', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'MODULE_CONTENT_PI_MODULAR_CONTENT_WIDTH', 'col-sm-12 mt-2', 'What container should the content be shown in? (col-*-12 = full width, col-*-6 = half width).', 6, 2, NOW());
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES (NULL, 'Installed Modules', 'MODULE_CONTENT_PI_INSTALLED', 'pi_name.php;pi_review_stars.php;pi_stock.php;pi_price.php;pi_gallery.php;pi_gallery_images.php;pi_img_disclaimer.php;pi_options_attributes.php;pi_date_available.php;pi_qty_input.php;pi_buy_button.php', 'List of &pi; Product Info child modules separated by a semi-colon. This is automatically updated. No need to edit.', 6, 0, now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Enable Module', 'PI_NAME_STATUS', 'True', 'Do you want to enable this module?', '6', '1', now(), NULL, 'Config::select_one([\'True\', \'False\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Module Display', 'PI_NAME_GROUP', 'C', 'Where should this module display on the product info page?', '6', '2', now(), NULL, 'Config::select_one([\'A\', \'B\', \'C\', \'D\', \'E\', \'F\', \'G\', \'H\', \'I\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'PI_NAME_CONTENT_WIDTH', 'col-sm-12 mb-2 ps-1', 'What container should the content be shown in? (col-*-12 = full width, col-*-6 = half width).', '6', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'PI_NAME_SORT_ORDER', '50', 'Sort order of display. Lowest is displayed first.', '6', '4', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Enable Module', 'PI_REVIEW_STARS_STATUS', 'True', 'Do you want to enable this module?', '6', '1', now(), NULL, 'Config::select_one([\'True\', \'False\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Module Display', 'PI_REVIEW_STARS_GROUP', 'C', 'Where should this module display on the product info page?', '6', '2', now(), NULL, 'Config::select_one([\'A\', \'B\', \'C\', \'D\', \'E\', \'F\', \'G\', \'H\', \'I\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'PI_REVIEW_STARS_CONTENT_WIDTH', 'col-sm-12 mb-2', 'What container should the content be shown in? (col-*-12 = full width, col-*-6 = half width).', '6', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'PI_REVIEW_STARS_SORT_ORDER', '55', 'Sort order of display. Lowest is displayed first.', '6', '4', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Enable Price Module', 'PI_STOCK_STATUS', 'True', 'Should this module be shown in the &pi; layout?', '6', '1', now(), NULL, 'Config::select_one([\'True\', \'False\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Module Display', 'PI_STOCK_GROUP', 'C', 'Where should this module display on the product info page?', '6', '2', now(), NULL, 'Config::select_one([\'A\', \'B\', \'C\', \'D\', \'E\', \'F\', \'G\', \'H\', \'I\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'PI_STOCK_CONTENT_WIDTH', 'col-sm-12', 'What container should the content be shown in?', '6', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Trigger', 'PI_STOCK_TRIGGER', '0', 'At or Below this number will trigger OOS.', '6', '4', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'PI_STOCK_SORT_ORDER', '60', 'Sort order of display. Lowest is displayed first.', '6', '5', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Enable Price Module', 'PI_PRICE_STATUS', 'True', 'Should this module be shown in the &pi; layout?', '6', '1', now(), NULL, 'Config::select_one([\'True\', \'False\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Module Display', 'PI_PRICE_GROUP', 'C', 'Where should this module display on the product info page?', '6', '2', now(), NULL, 'Config::select_one([\'A\', \'B\', \'C\', \'D\', \'E\', \'F\', \'G\', \'H\', \'I\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'PI_PRICE_CONTENT_WIDTH', 'col-sm-12 mb-2', 'What container should the content be shown in?', '6', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'PI_PRICE_SORT_ORDER', '65', 'Sort order of display. Lowest is displayed first.', '6', '4', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Enable Module', 'MODULE_CONTENT_ASR_TITLE_STATUS', 'True', 'Do you want to enable this module?', '6', '1', now(), NULL, 'Config::select_one([\'True\', \'False\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'MODULE_CONTENT_ASR_TITLE_CONTENT_WIDTH', 'col-12 mt-2', 'What container should the content be shown in? (col-*-12 = full width, col-*-6 = half width).', '6', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'MODULE_CONTENT_ASR_TITLE_SORT_ORDER', '10', 'Sort order of display. Lowest is displayed first.', '6', '3', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Enable Module', 'MODULE_CONTENT_ASR_SEARCH_RESULT_STATUS', 'True', 'Do you want to enable this module?', '6', '1', now(), NULL, 'Config::select_one([\'True\', \'False\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'MODULE_CONTENT_ASR_SEARCH_RESULT_CONTENT_WIDTH', 'col-12', 'What container should the content be shown in? (col-*-12 = full width, col-*-6 = half width).', '6', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'MODULE_CONTENT_ASR_SEARCH_RESULT_SORT_ORDER', '20', 'Sort order of display. Lowest is displayed first.', '6', '3', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'CU_FORM_CONTENT_WIDTH', 'col-sm-6 offset-sm-3', 'What container should the content be shown in? (col-*-12 = full width, col-*-6 = half width).', 6, 3, now());
