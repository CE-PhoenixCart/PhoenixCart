...
CREATE TABLE manufacturers (
  ...
  importers_name varchar(255) NULL,
  importers_address TEXT NULL,
  importers_email varchar(255) NULL,
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enable Description Module', 'MODULE_CONTENT_PI_MANUFACTURER_STATUS', 'True', 'Do you want to enable this module?', 6, 1, 'Config::select_one([\'True\', \'False\'], ', NOW());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Content Container', 'MODULE_CONTENT_PI_MANUFACTURER_CONTENT_WIDTH', 'col-sm-12 mb-4', 'What container should the content be shown in? (col-*-12 = full width, col-*-6 = half width).', 6, 2, NOW());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'MODULE_CONTENT_PI_MANUFACTURER_SORT_ORDER', '65', 'Sort order of display. Lowest is displayed first.', 6, 3, now());
