...
const HEADING_TITLE = 'Tax Zones';

const TABLE_HEADING_COUNTRY = 'Country';
...
const TEXT_INFO_NEW_SUB_ZONE_INTRO = 'Please enter the new sub zone information';

const TEXT_INFO_HEADING_EDIT_SUB_ZONE = 'Edit Sub Zone';
const TEXT_INFO_EDIT_SUB_ZONE_INTRO = 'Please make any necessary changes';

const TEXT_INFO_HEADING_DELETE_SUB_ZONE = 'Delete Sub Zone';
const TEXT_INFO_DELETE_SUB_ZONE_INTRO = 'Are you sure you want to delete this sub zone?';
...
const TYPE_BELOW = 'All Zones';
const PLEASE_SELECT = 'All Zones';
