...
const NAVBAR_TITLE_2 = 'Delivery To You';

const HEADING_TITLE = 'Delivery To You';

const TABLE_HEADING_SHIPPING_ADDRESS = 'Delivery Address';
const TABLE_HEADING_SHIPPING_METHOD = 'Delivery Method';
