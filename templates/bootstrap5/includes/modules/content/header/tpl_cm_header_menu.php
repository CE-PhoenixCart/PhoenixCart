<div class="<?= MODULE_CONTENT_HEADER_MENU_CONTENT_WIDTH ?> cm-header-menu">
  <nav class="navbar <?= $menu_style ?> cm-header-menu-navbar" data-bs-theme="<?= BOOTSTRAP_THEME ?>">
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#nbHeader" aria-controls="nbHeader" aria-expanded="false" aria-label="<?= MODULE_CONTENT_HEADER_MENU_TOGGLER ?>">
