<div class="col-sm-6 col-md-<?= (int)MODULE_CONTENT_FOOTER_CONTACT_US_CONTENT_WIDTH ?> cm-footer-contact-us">
  ...
  <ul class="list-unstyled">
    <li><a class="btn btn-success btn=role="button" href="<?= $GLOBALS['Linker']->build('contact_us.php') ?>"><i class="fas fa-paper-plane"></i> <?= MODULE_CONTENT_FOOTER_CONTACT_US_EMAIL_LINK ?></a></li>
  </ul>
</div>
