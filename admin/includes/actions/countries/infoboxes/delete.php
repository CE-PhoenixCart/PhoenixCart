...
*/
  ...
  $heading = TEXT_INFO_HEADING_DELETE_COUNTRY;

  $link = $GLOBALS['link']->set_parameter('cID', $cInfo->countries_id);

  $contents = ['form' => new Form('countries', (clone $link)->set_parameter('action', 'delete_confirm'))];
  $contents[] = ['text' => TEXT_INFO_DELETE_INTRO];
  $contents[] = ['class' => 'text-center text-uppercase fw-bold', 'text' => $cInfo->countries_name];
  $contents[] = [
    'class' => 'text-center',
