...
<div class="row row-cols-1 row-cols-md-2">
  <div class="col mb-4">
    <div class="card">
      <div class="card-header">
        <?= $OSCOM_PayPal->getDef('onboarding_intro_title') ?>
      </div>
      <div class="card-body">
  ...
  <div class="col mb-4">
    <div class="card">
      ...
      <div class="card-body">
        <?= $OSCOM_PayPal->getDef('manage_credentials_body', array('button_manage_credentials' => $OSCOM_PayPal->drawButton($OSCOM_PayPal->getDef('button_manage_credentials'), $GLOBALS['Admin']->link('paypal.php', ['action' => 'credentials']), 'warning'))) ?>
      </div>
    </div>
  </div>
</div>
