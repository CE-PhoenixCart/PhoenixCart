  ...
  if (isset($table_definition['info']->number_of_reviews) && ($table_definition['info']->number_of_reviews > 0)) {
    $contents[] = [
      'text' => '<div class="custom-control custom-switch">'
              . (new Tickable('delete_reviews', ['value' => 'on', 'class' => 'custom-control-input', 'id' => 'cDeleteReview'], 'checkbox'))->tick()
              . '<label for="cDeleteReview" class="custom-control-label text-muted"><small>'
