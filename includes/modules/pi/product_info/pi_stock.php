...
*/
  ...
  class pi_stock extends abstract_module {

    const CONFIG_KEY_BASE = 'PI_STOCK_';
    ...
    function __construct() {
      ...
      if ( $this->enabled ) {
        $this->group = 'pi_modules_' . strtolower(PI_STOCK_GROUP);
      }
    }

    function getOutput() {
      $on_hand = $GLOBALS['product']->get('in_stock');
      
      $stock_message = ($on_hand < PI_STOCK_TRIGGER) ? PI_STOCK_OOS : PI_STOCK_AVAILABLE;
    ...
    protected function get_parameters() {
      return [
        ...
        $this->config_key_base . 'TRIGGER' => [
          'title' => 'Trigger',
          'value' => '0',
          'desc' => 'At or Below this number will trigger OOS.',
        ],
