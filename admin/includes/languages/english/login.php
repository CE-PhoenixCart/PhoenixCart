...
const HEADING_TITLE = '<i class="fa fa-lock"></i> Secure Login Access';
...
const BUTTON_CREATE_ADMINISTRATOR = 'Create Administrator';

const ERROR_ACTION_RECORDER = '<strong>Error:</strong> The maximum number of login attempts has been reached. Please try again in %s minutes.';
