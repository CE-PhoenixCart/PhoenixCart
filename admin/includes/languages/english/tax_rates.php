...
const TEXT_INFO_INSERT_INTRO = 'Please enter the details of how the tax rate should be charged';
const TEXT_INFO_DELETE_INTRO = 'Are you sure you want to delete this tax rate?';
