    ...
    if (basename(Request::get_page()) !== 'login.php') {
      ...
      $output .= '<div class="col bg-light mb-1 border-bottom d-print-none">';
        $output .= '<ul class="nav justify-content-end">';
          ...
          $output .= '<li class="nav-item"><a class="nav-link" target="_blank" rel="noreferrer" href="https://phoenixcart.org/forum/addons/">' . $icon . ' ' . HEADER_TITLE_CERTIFIED_ADDONS . '</a></li>';
          $output .= '<li class="nav-item"><a class="nav-link" href="' . $GLOBALS['Admin']->link('certified_addons.php') . '">' . $icon . ' ' . HEADER_TITLE_CERTIFIED_DEVELOPERS . '</a></li>';
