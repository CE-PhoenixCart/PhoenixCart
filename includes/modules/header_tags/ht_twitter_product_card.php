...
*/
  ...
  class ht_twitter_product_card extends abstract_module {
    ...
    function execute() {
      ...
      if ( ('product_info.php' === Request::get_page()) && isset($_GET['products_id'], $product) ) {
          $data = [
            'card' => MODULE_HEADER_TAGS_TWITTER_PRODUCT_CARD_TYPE,
            'title' => $product->get('name'),
          ];

          if ( !Text::is_empty(MODULE_HEADER_TAGS_TWITTER_PRODUCT_CARD_SITE_ID) ) {
            $data['site'] = MODULE_HEADER_TAGS_TWITTER_PRODUCT_CARD_SITE_ID;
          }

          if ( !Text::is_empty(MODULE_HEADER_TAGS_TWITTER_PRODUCT_CARD_USER_ID) ) {
          ...
          $data['image'] = $GLOBALS['Linker']->build('images/' . $products_image, [], false);
    ...
    protected function get_parameters() {
      return [
        ...
        'MODULE_HEADER_TAGS_TWITTER_PRODUCT_CARD_TYPE' => [
          ...
          'set_func' => "Config::select_one(['summary', 'summary_large_image'], ",
        ],
