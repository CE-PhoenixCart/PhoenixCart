...
*/
  ...
  class cm_info_modular extends abstract_executable_module {
    ...
    public static function display_layout() {
      ...
      $slots = [
        'A' => ['width' => MODULE_CONTENT_INFO_MODULAR_A_WIDTH, 'color' => '96858f'],
        'B' => ['width' => MODULE_CONTENT_INFO_MODULAR_B_WIDTH, 'color' => '6d7993'],
        'C' => ['width' => MODULE_CONTENT_INFO_MODULAR_C_WIDTH, 'color' => '9099a2'],
        'D' => ['width' => MODULE_CONTENT_INFO_MODULAR_D_WIDTH, 'color' => 'd5d5d5'],
        'E' => ['width' => MODULE_CONTENT_INFO_MODULAR_E_WIDTH, 'color' => '96858f'],
        'F' => ['width' => MODULE_CONTENT_INFO_MODULAR_F_WIDTH, 'color' => '6d7993'],
        'G' => ['width' => MODULE_CONTENT_INFO_MODULAR_G_WIDTH, 'color' => '9099a2'],
        'H' => ['width' => MODULE_CONTENT_INFO_MODULAR_H_WIDTH, 'color' => 'd5d5d5'],
        'I' => ['width' => MODULE_CONTENT_INFO_MODULAR_I_WIDTH, 'color' => '96858f'],
      ];
