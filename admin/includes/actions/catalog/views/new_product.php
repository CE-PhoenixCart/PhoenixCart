    ...
    <div class="tab-content pt-3">
      <div class="tab-pane fade show active" id="section_data_content" role="tabpanel">
        ...
        <div class="form-group row" id="zDate">
          ...
          <div class="col-sm-9">
            <?= (new Input('products_date_available', ['id' => 'products_date_available', 'aria-describedby' => 'pDateHelp', 'class' => 'form-control w-25']))->require()->default_value($product->get('date_available') ?? '') ?>
