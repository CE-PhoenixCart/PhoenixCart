...
const TABLE_HEADING_SORT_ORDER_V = 'Vertical Sort Order';
const TABLE_HEADING_SORT_ORDER_H = 'Horizontal Sort Order';
...
const TEXT_INFO_VERTICAL_SORT_ORDER = 'Vertical Sort Order: %s';
